...
export default function StarSVG({
  ...
  return (
    <motion.svg
      ...
      fill="none"
      initial={{ fill: properties.darkerBg, opacity: 0.7, y: 0 }}
      whileHover={
        hoverAnimation
          ? active
            ? ableToClickWhileActive
              ? { fill: properties.darkerBg, opacity: 0.7 }
              : {}
            : { y: -5, fill: properties.highlightRed, opacity: 1 }
          : undefined
      }
